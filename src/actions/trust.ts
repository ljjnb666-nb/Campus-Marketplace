...
export async function createReview(
  ...
  try {
    ...
    return { ...initialState, message: actionErrorMessage(error, "createReview") };
  }
}
...
export async function blockUser(
  ...
  try {
    ...
    return { ...initialState, message: actionErrorMessage(error, "blockUser") };
  }
}
...
export async function unblockUser(
  ...
  try {
    ...
    return { ...initialState, message: actionErrorMessage(error, "unblockUser") };
  }
}
