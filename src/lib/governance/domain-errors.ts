...
export const GOVERNANCE_ERROR_CODES = [
  ...
  // Phase 7H：校区治理面 / 认证策略治理 seam 的稳定错误码
  "CAMPUS_NOT_FOUND",
  "CAMPUS_INPUT_INVALID",
  "CAMPUS_SLUG_INVALID",
...
export function governanceError(
  ...
  const defaults: Record<GovernanceErrorCode, string> = {
    ...
    ACTIVE_SUPPORT_TICKET: "账号存在进行中的支持工单，无法执行注销",
    ...
    CAMPUS_NOT_FOUND: "校区不存在",
    CAMPUS_INPUT_INVALID: "校区信息不完整或不合法",
